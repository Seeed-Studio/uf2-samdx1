/*
 * copied from .platformio/packages/framework-arduino-samd-seeed/variants/XIAO_m0/variant.h
*/

#include "variant.h"

/*
 * Pins descriptions (kept from Seeed XIAO
 */
const PinDescription g_APinDescription[]=
{
  ...
  // 4..5 - I2C SERCOM0
  { PORTA,  8, PIO_SERCOM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT), ADC_Channel16, PWM1_CH2, TCC1_CH2, EXTERNAL_INT_NMI },  // SDA: SERCOM0/PAD[0]
  { PORTA,  9, PIO_SERCOM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT), ADC_Channel17, PWM1_CH3, TCC1_CH3, EXTERNAL_INT_9 }, // SCL: SERCOM0/PAD[1]
  // 6..7 - UART SERCOM2
  { PORTA, 14, PIO_SERCOM, (PIN_ATTR_PWM|PIN_ATTR_TIMER), ADC_Channel2, PWM4_CH0, TC4_CH0, EXTERNAL_INT_8 }, // TX: SERCOM0/PAD[0]
  { PORTA, 15, PIO_SERCOM, (PIN_ATTR_PWM|PIN_ATTR_TIMER), ADC_Channel3, PWM4_CH1, TC4_CH1, EXTERNAL_INT_9 }, // RX: SERCOM0/PAD[1]
